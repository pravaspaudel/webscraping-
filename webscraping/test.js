...
const scrapdata = async () => {
  const url_web = "https://www.daraz.com.np/catalog/?page=50&q=mobile";
  ...
  fs.writeFileSync("page50.json", JSON.stringify(allProductDetails, null, 2));
  console.log("Data saved to page50.json");
